...
struct CreateAJOBFieldsHeights{
...
class CreateAJobVC: WSParent, UITableViewDataSource, UITableViewDelegate,ServicesDataHandlerProtocol {
        ...
        func intializeView(){
            self.headerView.titleLabel.text = "Create a Job"
  ...
  /*  func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
    ...
    {
        self.createJob()
        Common.showHUD("New job has been created", 1.0)
