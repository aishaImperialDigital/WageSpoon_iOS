...
class MessagesVC: WSParent, UITableViewDataSource, UITableViewDelegate {
    ...
    func intializeView(){
        self.headerView.titleLabel.text = "Messages"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        cell = tableView.dequeueReusableCell(withIdentifier: "MessagesCell") as? MessagesCell
        if cell == nil {
            cell = (MessagesCell(style: .default, reuseIdentifier: "MessagesCell"))
        }
