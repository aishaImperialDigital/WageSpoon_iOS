...
class EmployerBOWageSpoon : NSObject,Mappable, NSCoding{

	var data : EmployerBOData?
	var errorcode : Int?
	var errormsg : String?


	class func newInstance(map: Map) -> Mappable?{
		return EmployerBOWageSpoon()
	}
    ...
    */
	...
	{
         data = aDecoder.decodeObject(forKey: "data") as? EmployerBOData
